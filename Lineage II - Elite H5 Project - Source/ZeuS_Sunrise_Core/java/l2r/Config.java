...
public final class Config extends AbstractConfigs
{
	...
	// ClanHall Settings
	// --------------------------------------------------
	public static boolean L2SOW_ALLOW_DROP_CLONE;
	public static int L2SOW_ALLOW_DROP_CLONE_AMOUNT;
	...
	public static int OLYMPIAD_PERIOD_DAY;
	...
	public static String L2JMOD_DISMOUNT_IDS;
	public static String L2JMOD_GEO_SKIP_IDS;
	public static List<Integer> NPC_SKIP_TELEPORT_CHECK;
	public static List<Integer> AUTO_FLAG_MOBSID;
	public static boolean L2JMOD_BETA;
	...
	/** ZeuS **/
	public static int ZEUS_DROP_CHANCE;
	public static int ZEUS_INTERACTION_DISTANCE;
	public static Vector<Integer> ZEUS_DROP_CHANCE_BLACKLIST = new Vector<Integer>();
	public static Map<Integer, Integer> ZEUS_DROP_CHANCE_ITEMS = new HashMap<Integer, Integer>();
	public static int ZEUS_VALOR_AUMENTADO;
	public static int ZEUS_VALOR_AUMENTADO_SA;
	public static int ZEUS_VALOR_AUMENTADO_ARMOR;
	public static Vector<Integer> ZEUS_ITEM_WITHOUT_LIFETIME = new Vector<Integer>();
	public static String ZEUS_FORTRESS_ZONE_REWARD;
	public static boolean ZEUS_FORTRESS_DUALBOX_CHECK;
	public static int ZEUS_FORTRESS_EPAULETTE_RATE;
	public static int ZEUS_FORTRESS_MINUTES_TO_BEGIN;
	public static boolean ZEUS_7RB_CLAN_REPUTATION_REWARD_ACTIVE;
	public static int ZEUS_7RB_CLAN_REPUTATION_REWARD;
	public static boolean ZEUS_DISCARD_ITEM;
	public static Vector<Integer> ZEUS_DISCARD_ITEMS_ID = new Vector<Integer>();
	public static boolean ZEUS_7RB_SHOW_LEFT;
	public static boolean ZEUS_CERTIFICATION_MAIN_AND_SUBCLASS_FULL_SKILL;
	public static Map<Integer, List<Integer>> ZEUS_CERTIFICACION_CLASSES_SKILL_PROHIBITED = new HashMap<Integer, List<Integer>>();
	public static int ZEUS_CERTIFICACION_MAX_COUNT_SUBCLASS;
	public static boolean ZEUS_AUTO_ELEMENTAL_STONE;
	public static boolean ZEUS_USE_LINEAL_CANCEL;
	public static Vector<Integer> ZEUS_BLOCK_DROP_ITEM = new Vector<Integer>();
	public static boolean ZEUS_ENABLE_ELEMENT_PVP_ITEM;
	public static Vector<_expBonus> ZEUS_GENERAL_EXP_SP_PLUS = new Vector<_expBonus>();
	public static boolean ZEUS_SUBCLASS_CHANGE_ONLY_IN_PEACE_ZONE;
	/** ZeuS **/
	...
	public void loadConfigs()
	{
		if (Server.serverMode == Server.MODE_GAMESERVER)
		{
			...
			/** L2 SOW */
			L2SOW_ALLOW_DROP_CLONE = Feature.getBoolean("L2SOW_ALLOW_DROP_CLONE", false);
			L2SOW_ALLOW_DROP_CLONE_AMOUNT = Feature.getInt("L2SOW_ALLOW_DROP_CLONE_AMOUNT", 0);
			/** L2 SOW */
			...
			PropertiesParser ZeuSSettings = new PropertiesParser("./config/zeus/zeus_server_plus.properties");
			ZEUS_INTERACTION_DISTANCE = ZeuSSettings.getInt("ZEUS_NPC_INTERACTION_DISTANCE", 150);
			ZEUS_FORTRESS_ZONE_REWARD = ZeuSSettings.getString("FORTRESS_SPECIAL_REWARD", "");
			ZEUS_FORTRESS_DUALBOX_CHECK = ZeuSSettings.getBoolean("FORTRESS_SPECIAL_REWARD_CHECK_DUALBOX", false);
			ZEUS_FORTRESS_EPAULETTE_RATE = ZeuSSettings.getInt("FORTRESS_SPECIAL_EPAULETTE_RATE", -1);
			ZEUS_FORTRESS_MINUTES_TO_BEGIN = ZeuSSettings.getInt("FORTRESS_SPECIAL_CUSTOM_BEGIN_TIME", 60);
			ZEUS_VALOR_AUMENTADO = ZeuSSettings.getInt("PERCENTAGE_PRICE_ADDED", 0);
			ZEUS_VALOR_AUMENTADO_SA = ZeuSSettings.getInt("PERCENTAGE_PRICE_ADDED_TO_WEAPON_WITH_SA", 0);
			ZEUS_VALOR_AUMENTADO_ARMOR = ZeuSSettings.getInt("PERCENTAGE_PRICE_ADDED_TO_ARMOR", 0);
			ZEUS_DROP_CHANCE = ZeuSSettings.getInt("PERCENTAGE_CHANCE_FOR_ADDED_TO_ALL_WORLD", 0);
			
			String NoLifeTimeItem = ZeuSSettings.getString("ZEUS_ITEM_WITHOUT_LIFETIME", "");
			
			try
			{
				ZEUS_ITEM_WITHOUT_LIFETIME.clear();
			}
			catch (Exception a)
			{
			...
			if (NoLifeTimeItem != null)
			{
				if (NoLifeTimeItem.length() > 0)
				{
					if (NoLifeTimeItem.indexOf(",") > 0)
					{
						for (String ItemNoAdd : NoLifeTimeItem.split(","))
						{
							ZEUS_ITEM_WITHOUT_LIFETIME.add(Integer.valueOf(ItemNoAdd.trim()));
						}
					}
					else
					{
						ZEUS_ITEM_WITHOUT_LIFETIME.add(Integer.valueOf(NoLifeTimeItem.trim()));
					}
				}
			}
			
			ZEUS_7RB_CLAN_REPUTATION_REWARD_ACTIVE = ZeuSSettings.getBoolean("7RB_CLAN_REPUTATION_REWARD_ACTIVE", false);
			ZEUS_7RB_CLAN_REPUTATION_REWARD = ZeuSSettings.getInt("7RB_CLAN_REPUTATION_REWARD", 100);
			ZEUS_DISCARD_ITEM = ZeuSSettings.getBoolean("ALLOW_DISCARD_ITEM", false);
			ZEUS_7RB_SHOW_LEFT = ZeuSSettings.getBoolean("7RB_SHOW_RAIDBOSS_LEFT_WINDOWS", false);
			ZEUS_CERTIFICATION_MAIN_AND_SUBCLASS_FULL_SKILL = ZeuSSettings.getBoolean("CERTIFICATION_MAIN_AND_SUBCLASS_FULL_SKILL", false);
			
			try
			{
				ZEUS_CERTIFICACION_CLASSES_SKILL_PROHIBITED.clear();
			}
			catch (Exception a)
			{
			...
			String SkillTemp = ZeuSSettings.getString("CERTIFICACION_CLASSES_SKILL_PROHIBITED", "");
			if (SkillTemp != "")
			{
				if (SkillTemp.indexOf(";") >= 0)
				{
					for (String TempCadena : SkillTemp.split(";"))
					{
						int idClass = Integer.valueOf(TempCadena.split(":")[0]);
						ZEUS_CERTIFICACION_CLASSES_SKILL_PROHIBITED.put(idClass, new Vector<Integer>());
						String SkillsBlocks = TempCadena.split(":")[1];
						if (SkillsBlocks.indexOf(",") > 0)
						{
							for (String ParteSkill : SkillsBlocks.split(","))
							{
								ZEUS_CERTIFICACION_CLASSES_SKILL_PROHIBITED.get(idClass).add(Integer.valueOf(ParteSkill));
							}
						}
						else
						{
							ZEUS_CERTIFICACION_CLASSES_SKILL_PROHIBITED.get(idClass).add(Integer.valueOf(SkillsBlocks));
						}
					}
				}
				else
				{
					int idClass = Integer.valueOf(SkillTemp.split(":")[0]);
					ZEUS_CERTIFICACION_CLASSES_SKILL_PROHIBITED.put(idClass, new Vector<Integer>());
					String SkillsBlocks = SkillTemp.split(":")[1];
					if (SkillsBlocks.indexOf(",") >= 0)
					{
						for (String ParteSkill : SkillsBlocks.split(","))
						{
			...
			ZEUS_ENABLE_ELEMENT_PVP_ITEM = Boolean.parseBoolean(ZeuSSettings.getString("ZEUS_ENABLE_ELEMENT_PVP_ITEM", "false"));
			String _EXP_SP_PLUS = ZeuSSettings.getString("ZEUS_GENERAL_EXP_SP_PLUS", "");
			
			if (_EXP_SP_PLUS.length() > 0)
			{
				int Desde = 0;
				int Hasta = 0;
				int Bonus = 0;
				if (_EXP_SP_PLUS.indexOf(";") > 0)
				{
					for (String _temp : _EXP_SP_PLUS.split(";"))
					{
						Desde = Integer.valueOf(_temp.split(",")[0]);
						Hasta = Integer.valueOf(_temp.split(",")[1]);
						Bonus = Integer.valueOf(_temp.split(",")[2]);
						_expBonus tmp = new _expBonus(Desde, Hasta, Bonus);
						ZEUS_GENERAL_EXP_SP_PLUS.add(tmp);
					}
				}
				else
				{
					Desde = Integer.valueOf(_EXP_SP_PLUS.split(",")[0]);
					Hasta = Integer.valueOf(_EXP_SP_PLUS.split(",")[1]);
					Bonus = Integer.valueOf(_EXP_SP_PLUS.split(",")[2]);
					_expBonus tmp = new _expBonus(Desde, Hasta, Bonus);
					ZEUS_GENERAL_EXP_SP_PLUS.add(tmp);
				}
			}
			
			_log.info("General EXP SP Plus Bonus ->" + ZEUS_GENERAL_EXP_SP_PLUS.size());
			
			String tempBlock = ZeuSSettings.getString("ZEUS_BLOCK_DROP_ITEM", "");
			// ZEUS_BLOCK_DROP_ITEM
			if (tempBlock != null)
			{
				if (tempBlock.length() > 0)
				{
					try
					{
						ZEUS_BLOCK_DROP_ITEM.clear();
					}
					catch (Exception a)
					{
						
					}
					for (String ItemToBlock : tempBlock.split(","))
					{
						try
						{
							ZEUS_BLOCK_DROP_ITEM.add(Integer.valueOf(ItemToBlock));
						}
						catch (Exception a)
						{
							_log.warn("Error added Block Drop Item -> " + ItemToBlock);
						}
					}
					_log.info("Loaded " + ZEUS_BLOCK_DROP_ITEM.size() + " Bloqued Drop Item");
				}
			}
			
			ZEUS_AUTO_ELEMENTAL_STONE = ZeuSSettings.getBoolean("ZEUS_AUTO_ELEMENTAL_STONE", false);
			ZEUS_USE_LINEAL_CANCEL = ZeuSSettings.getBoolean("ZEUS_USE_LINEAL_CANCEL", false);
			
			ZEUS_SUBCLASS_CHANGE_ONLY_IN_PEACE_ZONE = ZeuSSettings.getBoolean("SUBCLASS_CHANGE_ONLY_IN_PEACE_ZONE", false);
			ZEUS_CERTIFICACION_MAX_COUNT_SUBCLASS = ZeuSSettings.getInt("CERTIFICACION_MAX_COUNT_SUBCLASS", 3);
			if (ZEUS_CERTIFICACION_MAX_COUNT_SUBCLASS <= 0)
			{
				ZEUS_CERTIFICACION_MAX_COUNT_SUBCLASS = MAX_SUBCLASS;
			}
			String tempStr = ZeuSSettings.getString("PERCENTAGE_CHANCE_ALL_WORLD_BLACKLIST", "");
			if (tempStr.trim().length() > 0)
			{
				if (ZEUS_DROP_CHANCE_BLACKLIST != null)
				{
					ZEUS_DROP_CHANCE_BLACKLIST.clear();
				}
				for (String Linea : tempStr.split(";"))
				{
					for (String IDs : Linea.split(","))
					{
						try
						{
							ZEUS_DROP_CHANCE_BLACKLIST.add(Integer.valueOf(IDs));
						}
						catch (Exception a)
						{
							_log.warn("ZeuS Error loading PERCENTAGE_CHANCE_ALL_WORLD_BLACKLIST ->" + IDs + "->" + a.getMessage());
						}
					}
				}
				if (ZEUS_DROP_CHANCE_BLACKLIST.size() > 0)
				{
					_log.warn("Loading " + ZEUS_DROP_CHANCE_BLACKLIST.size() + " item for Blacklist Chance World");
				}
			}
			
			tempStr = "";
			tempStr = ZeuSSettings.getString("CUSTOM_PERCENTAGE_CHANCE_BY_TO_ALL_WORLD", "");
			if (tempStr.trim().length() > 0)
			{
				if (ZEUS_DROP_CHANCE_ITEMS != null)
				{
					ZEUS_DROP_CHANCE_ITEMS.clear();
				}
				for (String Linea : tempStr.split(";"))
				{
					for (String idRate : Linea.split(","))
					{
						try
						{
							int idItem = Integer.valueOf(idRate.split(":")[0]);
							int ItemRate = Integer.valueOf(idRate.split(":")[1]);
							ZEUS_DROP_CHANCE_ITEMS.put(idItem, ItemRate);
						}
						catch (Exception a)
						{
							_log.warn("ZeuS error al crgar el DROP CHANCE->" + idRate + "-->" + a.getMessage());
						}
					}
				}
			}
			tempStr = "";
			tempStr = ZeuSSettings.getString("ALLOW_DISCARD_ITEMS_TO_DISCARD", "");
			if (tempStr.trim().length() > 0)
			{
				if (ZEUS_DISCARD_ITEMS_ID != null)
				{
					ZEUS_DISCARD_ITEMS_ID.clear();
				}
				
				for (String idItem : tempStr.split(","))
				{
					ZEUS_DISCARD_ITEMS_ID.add(Integer.valueOf(idItem));
				}
			}
			...
			L2JMOD_DISMOUNT_IDS = L2JModSettings.getString("BraceletOnUseDismount", "53000,53001");			
			L2JMOD_GEO_SKIP_IDS = L2JModSettings.getString("NpcIdSkipGeodataCheck", "53000,53001");
			String[] mobsFlagAuto = L2JModSettings.getString("RaidBossAndMinionIdAutoFlag", "53000,53001").split(",");
			AUTO_FLAG_MOBSID = new LinkedList<>();
			if(mobsFlagAuto.length>0) {
				for (String s : mobsFlagAuto) {
					int mobId = Integer.parseInt(s.trim());
					AUTO_FLAG_MOBSID.add(mobId);
				}
			}

			NPC_SKIP_TELEPORT_CHECK = new ArrayList<>();
			String[] npcSkipp = L2JModSettings.getProperty("NpcsToSkipTeleportToSpawn", "32893,").trim().split(",");
			for (String s : npcSkipp) {
				s = s.trim();
				NPC_SKIP_TELEPORT_CHECK.add(Integer.parseInt(s));
			}

			L2JMOD_BETA = L2JModSettings.getBoolean("ServerBetaMode", true);
			...
			OLYMPIAD_PERIOD_DAY = Integer.parseInt(Olympiad.getString("AltOlyPeriodEndDay", "1"));
	...
	public static int getExpSpBonusZeuSEngine(int Level)
	{
		if (ZEUS_GENERAL_EXP_SP_PLUS != null)
		{
			if (ZEUS_GENERAL_EXP_SP_PLUS.size() > 0)
			{
				for (_expBonus temp : ZEUS_GENERAL_EXP_SP_PLUS)
				{
					int Bonnus = temp.getPorcent(Level);
					if (Bonnus > 0)
					{
						return Bonnus;
					}
...
class _expBonus
{
	...
	public _expBonus(int FROM, int TO, int PORCENT)
	{
		this.From = FROM;
		this.To = TO;
	...
	public final int getPorcent(int LevelMonster)
	{
		if ((LevelMonster >= this.From) && (LevelMonster <= this.To))
		{
			return this.Porcent;
		}
		return 0;
