...
//		sysm.addInt(seconds);
		...
		String txt = "Server is going to be restarted in %time%";

		txt = txt.replace("%time%", getTime(seconds));

		Broadcast.toAllOnlinePlayers(new CreatureSay(0, Say2.ANNOUNCEMENT, "", txt));
	}

	public static String getTime(int intervall){
