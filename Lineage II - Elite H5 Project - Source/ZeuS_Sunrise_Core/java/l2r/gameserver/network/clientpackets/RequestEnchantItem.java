...
public final class RequestEnchantItem extends L2GameClientPacket
{
		...
		synchronized (item)
		{
			...
			switch (resultType)
			{
				...
				case SUCCESS:
				{
					...
					handleAnimation(activeChar, item.getEnchantLevel());
					...
					/*
					 * int minEnchantAnnounce = item.isArmor() ? 6 : 7; int maxEnchantAnnounce = item.isArmor() ? 0 : 15; if ((item.getEnchantLevel() == minEnchantAnnounce) || (item.getEnchantLevel() == maxEnchantAnnounce))
					 */
					if (ZeuS.AnunciarEnchant(item.getEnchantLevel()))
					{
				...
				case FAILURE:
				{
					...
					for(L2Character object : activeChar.getKnownList().getKnownPlayers().values()) {
						object.broadcastPacket(new MagicSkillUse(activeChar, 23121, 1, 3000, 0));
					}
	...
	public static void handleAnimation(L2PcInstance activeChar, int enchantLevel){
		switch (enchantLevel){
			case 1: handlePackage(activeChar,23097); break;
			case 2: handlePackage(activeChar,23098); break;
			case 3: handlePackage(activeChar,23099); break;
			case 4: handlePackage(activeChar,23100); break;
			case 5: handlePackage(activeChar,23101); break;
			case 6: handlePackage(activeChar,23102); break;
			case 7: handlePackage(activeChar,23103); break;
			case 8: handlePackage(activeChar,23104); break;
			case 9: handlePackage(activeChar,23105); break;
			case 10: handlePackage(activeChar,23106); break;
			case 11: handlePackage(activeChar,23107); break;
			case 12: handlePackage(activeChar,23108); break;
			case 13: handlePackage(activeChar,23109); break;
			case 14: handlePackage(activeChar,23110); break;
			case 15: handlePackage(activeChar,23111); break;
			case 16: handlePackage(activeChar,23112); break;
		}
		showEnchantAnimation(activeChar, enchantLevel);
	}

	public static void handlePackage(L2PcInstance activeChar, int skillId){
		GabrielUtils.handlePackage(activeChar, skillId);
	}
