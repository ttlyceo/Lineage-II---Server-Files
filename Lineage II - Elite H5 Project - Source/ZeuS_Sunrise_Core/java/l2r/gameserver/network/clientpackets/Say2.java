...
public final class Say2 extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (activeChar._isChatBlock)
		{
			activeChar.sendMessage("You can not chat with players in this event or location");
			return;
		}
		...
		if (handler != null)
		{
            if(PhantomControl.getInstance().onChat(_type, activeChar, _target, _text, handler)) {
                return;
            }
