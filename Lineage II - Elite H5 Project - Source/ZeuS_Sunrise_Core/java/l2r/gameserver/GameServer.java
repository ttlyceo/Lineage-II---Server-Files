...
public class GameServer
{
	...
	public GameServer() throws Exception
	{
        ...
        printSection("Gabriel Costa Souza Mods");
        GabrielModsInit.getInstance();
		GabInits.getInstance();
		...
		{
			_log.warn("Try to load all ZeuS Information but we get some error:->" + a.getMessage());
		}
