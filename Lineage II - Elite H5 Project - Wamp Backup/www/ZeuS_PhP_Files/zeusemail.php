<?php
	class EmailZeuS{
		...
		/***/
		public $WEB_LINK_TO_ACTIVE_DONATION = "http://54.38.110.61/ZeuS_PhP_Files/ZeuS_MaiN.php"; // For Admin 
		public $WEB_DONATION_LINK_KEY = "ffb83a391de6ebd66598ff87a8c2720c"; // Need to be the same on zeus_email.properties (WebDonationLinkKey)
		...
		function EmailZeuS(){
			...
			$this->GS_SERVER_NAME[1] = "L2Neptune";
			$this->GS_SERVER_NAME[6] = "L2Neptune Beta";
			$this->GS_SERVER_NAME[3] = "SERVER 3";
			$this->GS_SERVER_NAME[4] = "SERVER 4";

			$this->GS_IP[1] = "127.0.0.1";
			$this->GS_USER[1] = "root";
			$this->GS_PASS[1] = "iyxitrdz";
			$this->GS_BD[1] = "l2zeus";
			
			$this->GS_IP[6] = "127.0.0.1";
			$this->GS_USER[6] = "root";
			$this->GS_PASS[6] = "iyxitrdz";
			$this->GS_BD[6] = "l2zeus_beta";
