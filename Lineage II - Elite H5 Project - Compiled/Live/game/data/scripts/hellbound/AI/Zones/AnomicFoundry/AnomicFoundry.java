...
public final class AnomicFoundry extends AbstractNpcAI
{
	...
	{
		{LESSER_EVIL, 27883, 248613, -3209, -13248, 5}, //the last house is the amount of spawns that can exist
		{LESSER_EVIL, 26142, 246442, -3216, 7064, 10},
	...
	private int respawnTime = 60000; //min one minute
	private int respawnTimeBigger = 15000; 
	private int respawnTimeLesser = 15000; 
	private final int respawnMin = 20000; //aditional 20 secnds minimum
	private final int respawnMax = 300000; //aditional max 300 secoonds
	...
	public AnomicFoundry()
	{
		...
		startQuestTimer("make_spawn_1", respawnTimeLesser, null, null);
		startQuestTimer("make_spawn_2", respawnTimeBigger, null, null);
	}
